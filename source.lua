    ...
    if not isfolder(folderName .. "/sounds") then
        ...
        task.delay(1, function()
            for name, link in {
                ...
                ["rust"] = "https://www.myinstants.com/media/sounds/eaolwpzhgsba.mp3",
                ["stars"] = "https://www.myinstants.com/media/sounds/starshitsound.mp3",
                ["neverlose"] = "https://www.myinstants.com/media/sounds/neverlose-s.mp3"
            } do -- why so mean
